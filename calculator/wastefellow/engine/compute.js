...
function parse(string) {
	...
	var charlist = ['s', 'S', 'c', 'C', 't', 'T', 'l', 'L', '(', 'p', 'P', 'M', 'π']
...
function calculate(type, operation=null) {
	...
	if ((evaluated == 'error') || (type == 'conversion') || (base == 'from')
		...
		switch (type) {
			case 'area': case 'energy': case 'length': case 'mass': case 'pressure': case 'volume': case 'storage':
