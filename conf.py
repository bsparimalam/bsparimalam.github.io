...
project = 'Bharathy S. Parimalam'
copyright = '2023, Bharathy S. Parimalam'
author = 'Bharathy S. Parimalam'
language = 'en'
# release = '0.0.1'
html_title = author
...
html_logo = '_static/index.jpg'
html_favicon = '_static/index.jpg'
html_css_files = ['custom_rtd.css']
